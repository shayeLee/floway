(function (global, factory) {
	...
	***************************************************************************** */
	...
	var UnsubscriptionError$1 = /*@__PURE__*/ (function (_super) {
	    __extends(UnsubscriptionError, _super);
	    function UnsubscriptionError(errors) {
	        var _this = _super.call(this, errors ?
	            errors.length + " errors occurred during unsubscription:\n  " + errors.map(function (err, i) { return i + 1 + ") " + err.toString(); }).join('\n  ') : '') || this;
	...
	var Subscription$1 = /*@__PURE__*/ (function () {
	    ...
	    Subscription.prototype.unsubscribe = function () {
	        ...
	        if (isFunction$1(_unsubscribe)) {
	            ...
	            if (trial === errorObject$2) {
	                hasErrors = true;
	                errors = errors || (errorObject$2.e instanceof UnsubscriptionError$1 ?
	                    flattenUnsubscriptionErrors(errorObject$2.e.errors) : [errorObject$2.e]);
	            }
	        }
	...
	/** PURE_IMPORTS_START  PURE_IMPORTS_END */
	var rxSubscriber$2 = (typeof Symbol === 'function' && typeof Symbol.for === 'function')
	    ...
	    function Subscriber(destinationOrNext, error, complete) {
	        ...
	        switch (arguments.length) {
	            ...
	            case 1:
	                ...
	                if (typeof destinationOrNext === 'object') {
	                    if (isTrustedSubscriber(destinationOrNext)) {
	                        var trustedSubscriber = destinationOrNext[rxSubscriber$2]();
	                        _this.syncErrorThrowable = trustedSubscriber.syncErrorThrowable;
	                        _this.destination = trustedSubscriber;
	                        trustedSubscriber.add(_this);
	                    }
	...
	function isTrustedSubscriber(obj) {
	    return obj instanceof Subscriber$1 || ('syncErrorThrowable' in obj && obj[rxSubscriber$2]);
	}
	//# sourceMappingURL=Subscriber.js.map
	...
	var subscribeToPromise$2 = function (promise) {
	    return function (subscriber) {
	        promise.then(function (value) {
	            if (!subscriber.closed) {
	                subscriber.next(value);
	...
	var subscribeTo = function (result) {
	    if (result instanceof Observable$1) {
	    ...
	    else if (result && typeof result[observable$2] === 'function') {
	        ...
	        return subscribeToPromise$2(result);
	    }
	...
	var AuditSubscriber = /*@__PURE__*/ (function (_super) {
	    ...
	    AuditSubscriber.prototype._next = function (value) {
	        ...
	        if (!this.throttled) {
	            ...
	            if (duration === errorObject$2) {
	                this.destination.error(errorObject$2.e);
	            }
	            else {
	...
	var BufferWhenSubscriber = /*@__PURE__*/ (function (_super) {
	    ...
	    BufferWhenSubscriber.prototype.openBuffer = function () {
	        ...
	        if (closingNotifier === errorObject$2) {
	            this.error(errorObject$2.e);
	        }
	        else {
	...
	function isInteropObservable(input) {
	    return input && typeof input[observable$2] === 'function';
	}
	...
	function fromPromise$1(input, scheduler) {
	    if (!scheduler) {
	        return new Observable$1(subscribeToPromise$2(input));
	    }
	    else {
	        return new Observable$1(function (subscriber) {
	            var sub = new Subscription$1();
	...
	function fromObservable(input, scheduler) {
	    if (!scheduler) {
	        ...
	        return new Observable$1(function (subscriber) {
	            var sub = new Subscription$1();
	            sub.add(scheduler.schedule(function () {
	                var observable$$1 = input[observable$2]();
	...
	function from(input, scheduler) {
	    ...
	    if (input != null) {
	        if (isInteropObservable(input)) {
	            ...
	            return fromPromise$1(input, scheduler);
	        }
	...
	var DistinctUntilChangedSubscriber = /*@__PURE__*/ (function (_super) {
	    ...
	    DistinctUntilChangedSubscriber.prototype._next = function (value) {
	        ...
	        if (keySelector) {
	            ...
	            if (key === errorObject$2) {
	                return this.destination.error(errorObject$2.e);
	            }
	        }
	        var result = false;
	        if (this.hasKey) {
	            result = tryCatch$1(this.compare)(this.key, key);
	            if (result === errorObject$2) {
	                return this.destination.error(errorObject$2.e);
	            }
	        }
	        else {
	...
	var ExpandSubscriber = /*@__PURE__*/ (function (_super) {
	    ...
	    ExpandSubscriber.prototype._next = function (value) {
	        ...
	        if (this.active < this.concurrent) {
	            ...
	            if (result === errorObject$2) {
	                destination.error(errorObject$2.e);
	            }
	    ...
	    RetryWhenSubscriber.prototype.error = function (err) {
	        if (!this.isStopped) {
	            ...
	            if (!retries) {
	                ...
	                if (retries === errorObject$2) {
	                    return _super.prototype.error.call(this, errorObject$2.e);
	                }
	...
	var WindowToggleSubscriber = /*@__PURE__*/ (function (_super) {
	    ...
	    WindowToggleSubscriber.prototype.notifyNext = function (outerValue, innerValue, outerIndex, innerIndex, innerSub) {
	        if (outerValue === this.openings) {
	            ...
	            if (closingNotifier === errorObject$2) {
	                return this.error(errorObject$2.e);
	            }
	            else {
	                var window_1 = new Subject();
	                var subscription = new Subscription$1();
	...
	var Observer$2 = _global.MutationObserver || _global.WebKitMutationObserver;
	...
	var _microtask = function () {
	  ...
	  } else if (Observer$2 && !(_global.navigator && _global.navigator.standalone)) {
	    var toggle = true;
	    var node = document.createTextNode('');
	    new Observer$2(flush).observe(node, { characterData: true }); // eslint-disable-line no-new
	    notify = function () {
	...
	var Attract = function Attract(type, defaultValue) {
	  var event$ = _distributor$.pipe(pluck(type), filter(function (action) {
	    return action;
	  }));
	  ...
	  processEvent$.pipe = function () {
	    ...
	    var obs$ = pipe_3(operations)(event$);

	    return generateObs(obs$);
	  };

	  function generateObs(obs$) {
	    var obs$$ = new BehaviorSubject(defaultValue).pipe(filter(function (data) {
	...
	var testData$ = attract("refreshData", 456).pipe(switchMap(function () {
	  return fromPromise_2(getData());
	}));

	distributor$.next("refreshData");

	testData$.subscribe(function (val) {
	  console.log(val);
	});
